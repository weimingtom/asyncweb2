...
class HttpCodecUtils {
    ...
    static void throwDecoderException(String message,
        ...
        LOG.info("Decode failure. Cause: %s", message);
    ...
    static void encodeHeaders(
            HttpMessage msg, IoBuffer buffer, CharsetEncoder encoder) throws CharacterCodingException {
        
        try {
            for (Map.Entry<String, List<String>> header:msg.getHeaders().entrySet()) {
